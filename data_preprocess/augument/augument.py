...
class DataAugmentation(Dataset):
    def __init__(self,
        ...
        self.tokenizer_pr = MT5Tokenizer.from_pretrained(CKPT)
    ...
    def pr(self, text):
        ...
        return self.tokenizer_pr.decode(output[0], skip_special_tokens=True)

    def bt(self, text):
        en = self.translator.translate(text, src='vi', dest='en')
        vi = self.translator.translate(en.text, src='en', dest='vi')
        return vi.text
